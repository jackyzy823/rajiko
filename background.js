...
const coordinates = {"北海道":[43.46722222,142.8277778],
...
let GENERATED_DEVICE = function genDevice(){
    let sdk_vers = ["21","22","23","24","25"];//Math.floor(Math.random() * this.length)
    let devices = [ 'KYOCERA-E6560', 'KYOCERA-E6820', 'KYOCERA-E6820', 'KYOCERA-E6790', 'KYOCERA-C6745', 'KYOCERA-C6742A', 'KYOCERA-C6742', 'NEC_PC-TS508FAM',  'NEC-101T', 'NEC-101S', 'NEC-101S', 'NEC-102', 'NEC-NE-201A1A', 'NEC909e', 'SAMSUNG-SGH-I927', 'Samsung_Chromebook_3', 'Samsung_Chromebook_Plus', 'Samsung_Chromebook_Pro', 'SAMSUNG-SGH-I857', 'SAMSUNG-SM-G850A', 'SAMSUNG-SGH-I407', 'SAMSUNG-SGH-I827', 'SAMSUNG-EK-GC100', 'SAMSUNG-SM-G360AZ', 'SAMSUNG-SGH-I577', 'SAMSUNG-SGH-I437', 'SAMSUNG-SGH-I437P', 'SAMSUNG-SGH-I437Z', 'SAMSUNG-SM-G530A', 'SAMSUNG-SM-G530AZ', 'SAMSUNG-SM-J120AZ', 'SAMSUNG-SM-J120A', 'SAMSUNG-SM-J326AZ', 'SAMSUNG-SM-J327AZ', 'SAMSUNG-SM-J327A', 'SAMSUNG-SM-J320AZ', 'SAMSUNG-SM-J321AZ', 'SAMSUNG-SM-J320A', 'SAMSUNG-SM-J727AZ', 'SAMSUNG-SM-J727A', 'SAMSUNG-SGH-I527', 'SAMSUNG-SM-G750A', 'SAMSUNG-SGH-I717', 'SAMSUNG-SGH-I467', 'SAMSUNG-SM-N915A', 'SAMSUNG-SGH-I317', 'SAMSUNG-SM-P907A', 'SAMSUNG-SGH-I317', 'SAMSUNG-SM-N900A', 'SAMSUNG-SM-N910A', 'SAMSUNG-SM-N920A', 'SAMSUNG-SM-N930A', 'SAMSUNG-SGH-I747Z', 'SAMSUNG-SGH-I547', 'SAMSUNG-SGH-I897', 'SAMSUNG-SGH-I896', 'SAMSUNG-SGH-I927R', 'SAMSUNG-SGH-I777', 'SAMSUNG-SGH-I727', 'SAMSUNG-SGH-I747', 'SAMSUNG-SM-G730A', 'SAMSUNG-SGH-I337Z', 'SAMSUNG-SGH-I337', 'SAMSUNG-SGH-I537', 'SAMSUNG-SGH-I257', 'SAMSUNG-SM-C105A', 'SAMSUNG-SM-G900AZ', 'SAMSUNG-SM-G900A', 'SAMSUNG-SM-G870A', 'SAMSUNG-SM-G800A', 'SAMSUNG-SM-G920AZ', 'SAMSUNG-SM-G920A', 'SAMSUNG-SM-G890A', 'SAMSUNG-SM-G925A', 'SAMSUNG-SM-G928A', 'SAMSUNG-SM-G930AZ', 'SAMSUNG-SM-G930A', 'SAMSUNG-SM-G891A', 'SAMSUNG-SM-G935A', 'SAMSUNG-SGH-I957', 'SAMSUNG-SGH-I957D', 'SAMSUNG-SGH-I957M', 'SAMSUNG-SGH-I957R', 'SAMSUNG-SM-T377A', 'SAMSUNG-SM-T817A', 'SAMSUNG-SM-T818A', 'SAMSUNG-SGH-I497', 'SAMSUNG-SM-T217A', 'SAMSUNG-SM-T537A', 'SAMSUNG-SM-T337A', 'SAMSUNG-SM-T807A', 'SAMSUNG-SM-T707A', 'SAMSUNG-SM-T677A', 'SAMSUNG-SGH-I997', 'SAMSUNG-SGH-I997R', 'SAMSUNG-SGH-I847', 'SHARP-ADS1', 'Sony_Tablet_P', 'Sony_Tablet_P', 'Sony_Tablet_S','HUAWEI_D2-0082', 'HUAWEI_H892L', 'HUAWEI_CUN-L23', 'HUAWEI_Y560-L23', 'HUAWEI_G7-L02', 'HUAWEI_Y560-L03', 'HUAWEI_U8818', 'HUAWEI_H866C', 'HUAWEI_MLA-L12', 'HUAWEI_Y511-U30', 'HUAWEI_KII-L21', 'HUAWEI_HN3-U00', 'HUAWEI_Y310-5000', 'HUAWEI_LUA-L21', 'HUAWEI_Y221-U22', 'HUAWEI_Y550-L02', 'HUAWEI_Y336-U12', 'HUAWEI_Y530']
    return sdk_vers[(Math.floor(Math.random() * sdk_vers.length)) >> 0]+"."+devices[(Math.floor(Math.random() * devices.length)) >> 0];
}();

let GENERATED_APPVERSION = function genVersion(){
    let version = ["6.3.5","6.3.4","6.3.3","6.3.2","6.3.1"];
    return version[(Math.floor(Math.random() * version.length)) >> 0]
}();

let GENERATED_USERID = function genUserid(){
...
function genGPS(area_id){
    var latlong = coordinates[areaList[parseInt(area_id.substr(2)) - 1]];
    var lat = latlong[0];
    var long = latlong[1];
    lat = lat + Math.random() /10000.0 * (Math.random() > 0.5 ? 1 : -1);
    long = long + Math.random() /10000.0 * (Math.random() > 0.5 ? 1 : -1);
    return lat.toFixed(6)+","+long.toFixed(5)+",gps";
}

console.log("GENERATED_DEVICE",GENERATED_DEVICE);
console.log("GENERATED_APPVERSION",GENERATED_APPVERSION);
console.log("GENERATED_USERID",GENERATED_USERID);
        ...
        function (req) {
            if (req.url.indexOf("auth1") != -1 && req.method.toLowerCase() == 'get') {
                for (let i = 0; i < req.requestHeaders.length; i++) {
                    if (req.requestHeaders[i].name.toLowerCase() == "x-radiko-user") {
                        req.requestHeaders[i].value = GENERATED_USERID;
                    } else if (req.requestHeaders[i].name.toLowerCase() == "x-radiko-app-version") {
                        req.requestHeaders[i].value = GENERATED_APPVERSION;
                    } else if (req.requestHeaders[i].name.toLowerCase() == "x-radiko-app") {
                        req.requestHeaders[i].value = "aSmartPhone7a";
                    } else if (req.requestHeaders[i].name.toLowerCase() == "x-radiko-device") {
                        req.requestHeaders[i].value = GENERATED_DEVICE;
                    }
                }
                ...
                for (let i = 0; i < req.requestHeaders.length; i++) {
                    if (req.requestHeaders[i].name.toLowerCase() == "x-radiko-user") {
                        ...
                        req.requestHeaders[i].value = GENERATED_DEVICE;
                    } else if (req.requestHeaders[i].name.toLowerCase() == "x-radiko-partialkey") {
                        req.requestHeaders[i].value = partialkey;
                        partialkey = null; //next time also calc
                    }
                }
