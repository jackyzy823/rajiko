import { areaMap, radioAreaId, areaList, RULEID } from "./constants.js"
...
// TODO(mv3): use session rules or dynamic rules?
function updateAreaRules(area_id) {
  chrome.declarativeNetRequest.updateDynamicRules(
    {
      ...
      removeRuleIds: [RULEID.AREA, RULEID.AUTH2]
    }
  )
}
  ...
  chrome.runtime.onMessage.addListener(
    function (msg, sender, respCallback) {
      if (msg["update-area"]) {
        ...
        // NOTE(mv3): filterResponseData's listener will capture the area_id from closure 
        if ((typeof browser === "undefined") || !chrome.webRequest.filterResponseData) {
          updateAreaRules(area_id);
        }
  ...
  if (!(typeof browser === "undefined") && chrome.webRequest.filterResponseData) {
    chrome.webRequest.onBeforeRequest.addListener((req) => {
      ...
      filter.onstop = (event) => {
        ...
        // TODO(mv3): should area_id be refreshed when popup confrim clicked?
